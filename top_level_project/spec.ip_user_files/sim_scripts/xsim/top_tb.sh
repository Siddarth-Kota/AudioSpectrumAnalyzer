...
#
# Script generated by Vivado on Tue May 05 16:56:22 -0700 2026
...
# script info
echo -e "top_tb.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_17 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot top_tb xil_defaultlib.top_tb xil_defaultlib.glbl -log elaborate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm axis_infrastructure_v1_1_1 axis_data_fifo_v2_0_17)
